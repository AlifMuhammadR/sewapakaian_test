                        ...
                        <ul>
                            <li class="flex-w flex-t p-b-30">
                                <a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                    <img src="{{ asset('front-end/images/product-min-01.jpg') }}" alt="PRODUCT">
                                </a>
                            ...
                            <li class="flex-w flex-t p-b-30">
                                <a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                    <img src="{{ asset('front-end/images/product-min-02.jpg') }}" alt="PRODUCT">
                                </a>
                            ...
                            <li class="flex-w flex-t p-b-30">
                                <a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                    <img src="{{ asset('front-end/images/product-min-03.jpg') }}" alt="PRODUCT">
                                </a>

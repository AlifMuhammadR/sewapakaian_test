        ...
        <div class="row g-4">
            <div class="col-sm-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('clothes.update', $data->id) }}" method="POST" id="frmClothes"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="nama_pakaian" id="nama_pakaian" maxlength="100" type="text"
                                ...
                                value="{{ $data->nama_pakaian ? $data->nama_pakaian : old('nama_pakaian') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="jenis" id="jenis" maxlength="100" type="text"
                                aria-label="default input example" value="{{ $data->jenis ? $data->jenis : old('jenis') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="model" id="model" maxlength="100" type="text"
                                aria-label="default input example" value="{{ $data->model ? $data->model : old('model') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="warna" id="warna" maxlength="50" type="text"
                                aria-label="default input example" value="{{ $data->warna ? $data->warna : old('warna') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="ukuran" name="ukuran" aria-label="Default select example">
                                ...
                                <option value="S" @if ($data->ukuran === 'S' || old('ukuran') === 'S') selected @endif>S
                                </option>
                                <option value="M" @if ($data->ukuran === 'M' || old('ukuran') === 'M') selected @endif>M
                                </option>
                                <option value="L" @if ($data->ukuran === 'L' || old('ukuran') === 'L') selected @endif>L
                                </option>
                                <option value="XL" @if ($data->ukuran === 'XL' || old('ukuran') === 'XL') selected @endif>XL
                                </option>
                                <option value="2XL" @if ($data->ukuran === '2XL' || old('ukuran') === '2XL') selected @endif>2XL
                                </option>
                                <option value="3XL" @if ($data->ukuran === '3XL' || old('ukuran') === '3XL') selected @endif>3XL
                                </option>
                                <option value="4XL" @if ($data->ukuran === '4XL' || old('ukuran') === '4XL') selected @endif>4XL
                                </option>
                                <option value="5XL" @if ($data->ukuran === '5XL' || old('ukuran') === '5XL') selected @endif>5XL
                                </option>
                                <option value="6XL" @if ($data->ukuran === '6XL' || old('ukuran') === '6XL') selected @endif>6XL
                                </option>
                                <option value="All Size" @if ($data->ukuran === 'All Size' || old('ukuran') === 'All Size') selected @endif>All Size
                                </option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="bahan" id="bahan" maxlength="50" type="text"
                                aria-label="default input example" value="{{ $data->bahan ? $data->bahan : old('bahan') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="deskripsi" id="deskripsi" rows="7">{{ $data->deskripsi ? $data->deskripsi : old('deskripsi') }}</textarea>
                            <div id="clothesHelp" class="form-text text-warning">Clothes <b
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control text-end" name="stok" id="stok" maxlength="30"
                                type="text" aria-label="default input example"
                                value="@if ($data->stok) {{ $data->stok }} @elseif (old('stok')) {{ old('stok') }} @else {{ '0' }} @endif">
                            <div id="clothesHelp" class="form-text text-warning">Clothes <b
                        ...
                        <div class="mb-3">
                            <label for="harga_sewa" class="form-label">Rental's piece</label>
                            <input class="form-control text-end" name="harga_sewa" id="harga_sewa" maxlength="30"
                                type="text" aria-label="default input example"
                                value="@if ($data->harga_sewa) {{ $data->harga_sewa }} @elseif (old('harga_sewa')) {{ old('harga_sewa') }} @else {{ '0' }} @endif">
                            <div id="clothesHelp" class="form-text text-warning">
